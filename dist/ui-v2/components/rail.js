...
export function rail(items, activeIndex, width) {
    return box("단계", items.map((item, index) => selectionRow(labelOf(item, index), index === activeIndex)), width);
}
export function tabStrip(items, activeIndex, width) {
