...
export function getStringOption(args, name) {
...
export function getBooleanOption(args, name) {
    return args.options[name] === true || args.options[name] === "true";
}
export function getListOption(args, name) {
    const value = args.options[name];
    if (!value) {
        return [];
    }
...
export function requireStringOption(args, name) {
