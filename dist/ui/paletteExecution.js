...
export async function executePaletteCommand(context) {
...
async function executeGlobalPaletteCommand(context) {
...
async function executeProjectPaletteCommand(context, projectDir) {
    const commandId = context.commandId;
...
function glossaryFilterForCommand(commandId) {
