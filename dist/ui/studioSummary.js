...
export function studioActionLines(model, session) {
...
export function studioProgressLines(model) {
...
export function studioWorkflowLines(model) {
...
export function studioQualityLines(model) {
...
export function studioTimelineLines(model) {
...
export function studioSessionLines(session) {
    return table([
...
function queuePreview(label, items) {
    if (items.length === 0) {
        return [`${label}: 없음`];
    }
...
function timelineMarker(severity) {
    if (severity === "error") {
        return "!";
    }
    if (severity === "warning") {
...
function sourceWarningLabel(warning) {
