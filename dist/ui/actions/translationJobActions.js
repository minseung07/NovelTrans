...
export async function createProjectAdapter(projectDir, runtime) {
...
export async function createProjectTranslationSession(projectDir, mode, runtime) {
...
async function loadRuntimeProjectMetadata(projectDir, runtime) {
