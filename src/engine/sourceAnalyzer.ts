import type { Episode, SourceAnalysis } from "../domain/episode.js";
...
export function analyzeSource(sourceText: string): SourceAnalysis {
...
function guessTitle(episodes: Episode[]): string {
