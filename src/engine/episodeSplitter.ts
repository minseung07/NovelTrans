...
export function splitEpisodes(sourceText: string): Episode[] {
...
export function hasEpisodeHeadings(sourceText: string): boolean {
...
function buildEpisode(episodeNo: number, title: string, sourceText: string, body: string): Episode {
...
function splitEpisodeSections(body: string): { foreword?: string; body: string; afterword?: string } {
...
function splitForeword(body: string): { foreword?: string; body: string } {
...
function splitAfterword(body: string): { body: string; afterword?: string } {
  const normalized = normalizeNewlines(body).trim();
  const lines = normalized.split("\n");
...
function guessSingleTitle(lines: string[]): string {
