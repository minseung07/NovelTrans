...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_local.add_argument("--formats", default="txt,docx,epub")
    ...
    run_url.add_argument("--formats", default="txt,docx,epub")
    ...
    export.add_argument("--formats", default="txt,docx,epub")
