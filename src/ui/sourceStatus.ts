import type { SourceAnalysis, Episode } from "../domain/episode.js";
import type { ProjectMetadata } from "../domain/project.js";
import type { SourceStatus } from "./types.js";

export function buildSourceStatus(metadata: ProjectMetadata, episodes: Episode[], analysis: SourceAnalysis | null): SourceStatus {
  return {
